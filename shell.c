        ...
        if (c == '\x1b') {
            ...
            if (buffer_length + remaining_bytes + 1 < sizeof(input)) {
                ...
                if (cursor_position < buffer_length) {
                    ...
                    memmove(input + cursor_position + len, input + cursor_position, buffer_length - cursor_position);
                    ...
                    for (size_t i = cursor_position; i <
                    buffer_length; i += utf8_char_length(input[i])) {
