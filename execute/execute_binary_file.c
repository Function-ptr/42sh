...
** execute_binary_file.c
** File description:
** execute a binary file given path it's path
*/
/*
 __  __        _                            ___            ___
|  \/  |      | |                          / _ \          / _ \.
...
void clean_up_forking(char *filepath, char **argv, char **envtab,
    command_t *command)
{
...
pid_t fork_and_run(char *filepath, command_t *command, envvar_t **env)
{
    ...
    clean_up_forking(filepath, argv, envtab, command);
    return (child_pid);
}
/*
⠀⠀⠀⠀⠀⠀⠀⠀⢀⡴⠊⠉⠉⢉⠏⠻⣍⠑⢲⠢⠤⣄⣀⠀⠀⠀⠀⠀⠀⠀
